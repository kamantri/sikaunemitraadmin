...
CREATE TABLE IF NOT EXISTS tokens (
  id INT PRIMARY KEY AUTO_INCREMENT,
  user_id INT NOT NULL,
  token VARCHAR(255) NOT NULL,role VARCHAR(50) NOT NULL,
...
('Admin User', 'admin@sikaunemitra.com', '$2y$10$7z9c7.6i6zK8YCK4rRItSOpvXjRIH/RgYkVQWjZB6SVrYxNKP2kP2', 'admin'),
('John Doe', 'john.admin@sikaunemitra.com', '$2y$10$7z9c7.6i6zK8YCK4rRItSOpvXjRIH/RgYkVQWjZB6SVrYxNKP2kP2', 'admin'),
('Sarah Johnson', 'sarah.admin@sikaunemitra.com', '$2y$10$7z9c7.6i6zK8YCK4rRItSOpvXjRIH/RgYkVQWjZB6SVrYxNKP2kP2', 'admin'),
('Michael Brown', 'michael.admin@sikaunemitra.com', '$2y$10$7z9c7.6i6zK8YCK4rRItSOpvXjRIH/RgYkVQWjZB6SVrYxNKP2kP2', 'admin'),
('Jessica Lee', 'jessica.admin@sikaunemitra.com', '$2y$10$7z9c7.6i6zK8YCK4rRItSOpvXjRIH/RgYkVQWjZB6SVrYxNKP2kP2', 'admin');
